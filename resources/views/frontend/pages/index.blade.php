...
<section id="portfolio" class="portfolio section-bg">
    <div class="container" data-aos="fade-up" data-aos-delay="100">
        ...
        <div class="section-title">
            <h2>{{$detailed_page->title}}</h2>
            <p>{{$detailed_page->description}} </p>
        </div>
        <div class="row portfolio-container">
            <div class="col-lg-12 col-md-12 portfolio-item filter-app">
                <div class="portfolio-wrap">
                    <img src="{{ asset('uploads/content/'.$detailed_page->cover) }}" class="img-fluid w-100" alt="">
                    <div class="portfolio-info">
                        <div class="portfolio-links">
                            <a href="{{ asset('uploads/content/'.$detailed_page->cover) }}" data-gallery="portfolioGallery" class="portfolio-lightbox" title="{{$detailed_page->title}}"><i class="bi bi-plus"></i></a>
                        </div>
                    </div>
                </div>
            </div>
